    ...
    <div id="content-wrapper">
      ...
      <?php if(isset($succ)) {?>
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item ">Buy Vehicle</li>
        ...
        ?>
          ...
          <div class="form-group">
            ...
            <div class="form-group" style="display:none">
                <label for="exampleInputEmail1">Buy Status</label>
                <input type="text" value="Pending" class="form-control" id="exampleInputEmail1"  name="u_car_book_status">
            </div>
  
            <button type="submit" name="book_vehicle" class="btn btn-success">Confirm Purchase</button>
          </form>
          <!-- End Form-->
        <?php }?>
        </div>
