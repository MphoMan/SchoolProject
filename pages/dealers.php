...
<head>
    ...
    <title>INFINITE AUTOMOTIVE - Dealer </title>
        ...
        <section>
            ...
            <div class="grid-dealerships">	
                <div class="card-dealership"> <!-- Dealer Card --> 
                    ...
                    <a class="btn-see-cars-dealership" href="#modal-see-cars">See Cars</a>
                ...
                <div class="card-dealership">
                    <img src="../assets/img/images/dealership/fiat.webp" alt="dealership fiat" width="20%">
                    <div class="brand-dealership">
                        <img src="../assets/img/images/buy-home/fiat-logo.webp" alt="logo fiat" width="50">
                        <div>
                            <p>Dealership</p>
                            <p><b>Fiat</b></p>
                        </div>
                ...
                <div class="card-dealership">
                    <img src="../assets/img/images/dealership/mercedes.webp" alt="dealership mercedes" width="20%">
                    <div class="brand-dealership">
                ...
                <div class="card-dealership"> 
                    <img src="../assets/img/images/dealership/ford.webp" alt="dealership ford" width="20%">
                    <div class="brand-dealership">
                ...
                <div class="card-dealership"> 
                    <img src="../assets/img/images/dealership/chevrolet.webp" alt="dealership chevrolet" width="20%">
                    <div class="brand-dealership">
                        <img src="../assets/img/images/buy-home/chevrolet-logo.webp" alt="logo chevrolet" width="50">
                        <div>
                            <p>Dealership</p>
                            <p><b>Chevrolet</b></p>
                        </div>
            ...
            <!-- Modal See Cars -->
            <section id="modal-see-cars" class="modal-see-cars">
                <div class="modal-see-cars-container">
                    <header class="modal-view-cars-header">
                        ...
                        <a href="#modal-contact" class="btn-contact-mva">Contact</a>
                    ...
                    <section class="available-cars">
                        ...
                        <div class="con-cars">
                            <div class="ccar-card">
                                <img src="../assets/img/images/buy-home/vw-golf-hatchback.webp" alt="Volkswagen Golf GTI">
                                <h4>Golf GTI</h4>
                                <p>R <span>320 900</span></p>
                                <a href="#modal-contact" class="btn-interested">I'm interested</a>
                            </div>
                            <div class="ccar-card">
                                <img src="../assets/img/images/dealership/vw-tiguan-wb.webp" alt="Volkswagen Tiguan">
                                <h4>Tiguan 2021</h4>
                                <p>R <span>280 900</span></p>
                                <a href="#modal-contact" class="btn-interested">I'm interested</a>
                            </div>
                            <div class="ccar-card">
                                <img src="../assets/img/images/dealership/vw-vento-wb.webp" alt="Vento GLI">
                                <h4>Vento GLI</h4>
                                <p>R <span>350 700</span></p>
                                <a href="#modal-contact" class="btn-interested">I'm interested</a>
                            </div>
                        </div>
                    </section>
